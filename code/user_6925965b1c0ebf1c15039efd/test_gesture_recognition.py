...
# STATIC_HOLD_TIME = 1.0  # Hold static gesture for 1.5 seconds
# STATIC_DELTA_THRESHOLD = 0.003  # Further lowered for 2m+ distance
# STATIC_DETECTION_THRESHOLD = 0.002  # Lowered for motion detection during recording
